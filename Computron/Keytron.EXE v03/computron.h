...
public:
	...
	Instruction ( )
	{
		...
		instruc_keystrokeCode = 0;
		instruc_keystrokeNum = 0;
	...
	int instruc_keystrokeNum;
	int get_instruc_keystrokeNum( ) { return instruc_keystrokeNum; }
	void set_instruc_keystrokeNum( int a ) { instruc_keystrokeNum = a; }
	...
	/*bool*/int safety_useSensusCheck;
	/*bool*/int get_safety_useSensusCheck( ) { return safety_useSensusCheck; }
	void set_safety_useSensusCheck( int a ) { safety_useSensusCheck = a; }
